...
* https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.3/html-single/getting_started_with_red_hat_developer_hub/index#assembly-auth-provider-github[Set up GitHub Authentication^]
