...
* https://www.npmjs.com/package/@janus-idp/backstage-plugin-rbac-backend[Janus IDP RBAC REST API^]
* https://docs.redhat.com/en/documentation/red_hat_developer_hub/1.0/html/administration_guide_for_red_hat_developer_hub/con-rbac-overview_admin-rhdh[RBAC resource types in RHDH^]
