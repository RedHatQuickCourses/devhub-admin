...
This course is the _second_ in a series of _three_ courses about Red Hat Developer Hub (RHODS). This course teaches you how to install, upgrade and uninstall RHDH, and how to perform basic configuration of RHDH after installation.
...
```
    $ git clone git@github.com:RedHatQuickCourses/devhub-admin.git
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/devhub-admin

# Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/devhub-admin/issues
